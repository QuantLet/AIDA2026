...
def main():
    ...
    (ROOT / "Metainfo.txt").write_text(metainfo(
        "AIDA2026",
        "Lecture deck and two-hour coding laboratory asking whether pretrained models "
        "produce valid 1% Value at Risk forecasts. Five assets, 500 out-of-sample days "
        "and one frozen protocol compare historical simulation, GARCH(1,1)-t, a neural "
        "volatility model, Chronos-Bolt, Chronos-T5, four configurations of a "
        "commercial language model and two ways of reading a quantile out of an "
        "open-weights model. Every figure and table is generated by a script, and a "
        "checker re-derives every number printed on a slide from the data. "
